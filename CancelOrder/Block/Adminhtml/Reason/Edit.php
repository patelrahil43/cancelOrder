 ...
 */
namespace Infobit\CancelOrder\Block\Adminhtml\Reason;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    /**
     * Initialize reason page edit block
     *
     * @return void
     */
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Infobit_CancelOrder::save')) {
...
//        }
    ...
    {
        if ($this->_coreRegistry->registry('cancelorder_reason')->getId()) {
            return __("Edit Reason '%1'", $this->escapeHtml($this->_coreRegistry->registry('cancelorder_reason')->getTitle()));
        } else {
